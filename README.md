...
У нас вышло получить сервис с Accuracy = 87%. В начале для повышения эффективности модели предлагается выбрать является изображение сканом или фото. Алгоритм четко определяет нераспознанные ячейки, что исключает трату времени на проверку распознанных ячеек.
